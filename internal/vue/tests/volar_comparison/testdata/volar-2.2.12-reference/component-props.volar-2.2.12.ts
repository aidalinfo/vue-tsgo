...
/** @type {[typeof ChildComp, ]} */;
// @ts-ignore
const __VLS_0 = __VLS_asFunctionalComponent(ChildComp, new ChildComp({
foo: (__VLS_ctx.name),
bar: "static",
}));
...
/** @type {[typeof ChildComp, ]} */;
// @ts-ignore
const __VLS_3 = __VLS_asFunctionalComponent(ChildComp, new ChildComp({
foo: "missing-bar",
}));
...
setup() {
return {
ChildComp: ChildComp as typeof ChildComp,
