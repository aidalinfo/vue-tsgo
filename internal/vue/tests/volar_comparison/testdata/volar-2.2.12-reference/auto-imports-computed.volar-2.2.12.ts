...
const __VLS_8 = ({} as __VLS_WithComponent<'FText', __VLS_LocalComponents, void, 'FText', 'FText', 'FText'>).FText;
...
setup() {
return {
count: count as typeof count,
localCount: localCount as typeof localCount,
doubled: doubled as typeof doubled,
