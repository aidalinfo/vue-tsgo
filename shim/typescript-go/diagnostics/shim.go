...
func Message_Set_code(v *diagnostics.Message, field int32) {
	((*extra_Message)(unsafe.Pointer(v))).code = field
}
func Message_Set_category(v *diagnostics.Message, field diagnostics.Category) {
	((*extra_Message)(unsafe.Pointer(v))).category = field
}
func Message_Set_key(v *diagnostics.Message, field diagnostics.Key) {
	((*extra_Message)(unsafe.Pointer(v))).key = field
}
func Message_Set_text(v *diagnostics.Message, field string) {
	((*extra_Message)(unsafe.Pointer(v))).text = field
}
